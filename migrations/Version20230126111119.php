 ...
 */
final class Version20230126111119 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partie_corps ADD CONSTRAINT FK_7655A469BF396750 FOREIGN KEY (id) REFERENCES exercises (id)');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE partie_corps DROP FOREIGN KEY FK_7655A469BF396750');
