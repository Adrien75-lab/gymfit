 ...
 */
final class Version20230112111331 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE body_parts (id INT AUTO_INCREMENT NOT NULL, name VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE exercises ADD body_parts_id INT NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE cible cible VARCHAR(255) NOT NULL, CHANGE description description LONGTEXT NOT NULL, CHANGE created_at created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE updated_at updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\'');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE member_coach (member_id INT NOT NULL, coach_id INT NOT NULL, INDEX IDX_5D78F83F7597D3FE (member_id), INDEX IDX_5D78F83F3C105691 (coach_id), PRIMARY KEY(member_id, coach_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE exercises DROP body_parts_id, CHANGE id id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE cible cible TEXT NOT NULL, CHANGE description description TEXT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
}
