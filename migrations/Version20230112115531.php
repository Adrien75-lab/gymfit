 ...
 */
final class Version20230112115531 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises CHANGE id id INT AUTO_INCREMENT NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises CHANGE id id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL');
    }
}
