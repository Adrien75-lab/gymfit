 ...
 */
final class Version20230112122929 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE body_parts ADD test VARCHAR(255) NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE body_parts DROP test');
        $this->addSql('ALTER TABLE exercises CHANGE id id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE cible cible TEXT NOT NULL, CHANGE description description TEXT NOT NULL, CHANGE created_at created_at DATETIME DEFAULT NULL, CHANGE updated_at updated_at DATETIME DEFAULT NULL');
    }
}
