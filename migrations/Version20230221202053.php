 ...
 */
final class Version20230221202053 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user DROP age, DROP kilos, DROP calories');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD age INT DEFAULT NULL, ADD kilos INT DEFAULT NULL, ADD calories INT DEFAULT NULL');
    }
}
