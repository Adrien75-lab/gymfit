 ...
 */
final class Version20230112103611 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises ADD description LONGTEXT NOT NULL, ADD created_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', ADD updated_at DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', CHANGE cible cible VARCHAR(255) NOT NULL, CHANGE equipement equipement VARCHAR(255) NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises DROP description, DROP created_at, DROP updated_at, CHANGE cible cible JSON NOT NULL, CHANGE equipement equipement VARCHAR(171) NOT NULL');
    }
}
