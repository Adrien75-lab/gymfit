 ...
 */
final class Version20230112084955 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partie (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE exercises ADD body_part_id INT DEFAULT NULL');
        $this->addSql('ALTER TABLE exercises ADD CONSTRAINT FK_FA14991A515F27A FOREIGN KEY (body_part_id) REFERENCES partie (id)');
        $this->addSql('CREATE INDEX IDX_FA14991A515F27A ON exercises (body_part_id)');
    }

    public function down(Schema $schema): void
    {
        // this down() migration is auto-generated, please modify it to your needs
        $this->addSql('ALTER TABLE exercises DROP FOREIGN KEY FK_FA14991A515F27A');
        ...
        $this->addSql('DROP INDEX IDX_FA14991A515F27A ON exercises');
        $this->addSql('ALTER TABLE exercises DROP body_part_id');
    }
}
