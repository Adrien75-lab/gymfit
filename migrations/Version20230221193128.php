 ...
 */
final class Version20230221193128 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE user ADD CONSTRAINT FK_8D93D6496BC6FD7D FOREIGN KEY (coach_id_id) REFERENCES user (id)');
