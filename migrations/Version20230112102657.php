 ...
 */
final class Version20230112102657 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises ADD body_parts_id INT NOT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises DROP body_parts_id, CHANGE id id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL');
    }
}
