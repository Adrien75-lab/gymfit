 ...
 */
final class Version20230303152213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach ADD user_id INT DEFAULT NULL, CHANGE id id INT AUTO_INCREMENT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE coach DROP user_id, CHANGE id id INT NOT NULL');
