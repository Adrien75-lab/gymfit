 ...
 */
final class Version20230112091348 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises DROP FOREIGN KEY FK_FA14991A515F27A');
        $this->addSql('ALTER TABLE exercises ADD CONSTRAINT FK_FA14991A515F27A FOREIGN KEY (body_part_id) REFERENCES body_part (id)');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE partie (id INT AUTO_INCREMENT NOT NULL, nom VARCHAR(255) CHARACTER SET utf8mb4 NOT NULL COLLATE `utf8mb4_unicode_ci`, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB COMMENT = \'\' ');
        ...
        $this->addSql('ALTER TABLE exercises DROP FOREIGN KEY FK_FA14991A515F27A');
        $this->addSql('ALTER TABLE exercises ADD CONSTRAINT FK_FA14991A515F27A FOREIGN KEY (body_part_id) REFERENCES partie (id) ON UPDATE NO ACTION ON DELETE NO ACTION');
    }
}
