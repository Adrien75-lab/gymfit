 ...
 */
final class Version20230110163335 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises DROP equipement, DROP description, DROP created_at, DROP updated_at, CHANGE id id INT AUTO_INCREMENT NOT NULL, CHANGE cible cible JSON NOT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE exercises ADD equipement VARCHAR(255) NOT NULL, ADD description TEXT NOT NULL, ADD created_at DATETIME DEFAULT NULL, ADD updated_at DATETIME DEFAULT NULL, CHANGE id id BIGINT UNSIGNED AUTO_INCREMENT NOT NULL, CHANGE cible cible LONGTEXT NOT NULL COLLATE `utf8mb4_bin`');
    }
}
