...
class getApiPlatform_Messenger_DataTransformerService extends App_KernelDevDebugContainer
{
    ...
    public static function do($container, $lazyLoad = true)
    {
        ...
        if (isset($container->privates['api_platform.messenger.data_transformer'])) {
            return $container->privates['api_platform.messenger.data_transformer'];
        }

        return $container->privates['api_platform.messenger.data_transformer'] = new \ApiPlatform\Core\Bridge\Symfony\Messenger\DataTransformer($a);
    }
}
