...
class App_KernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'App\\Controller\\BodyPartController' => 'getBodyPartControllerService',
            'App\\Controller\\CustomersController' => 'getCustomersControllerService',
            ...
            'App\\Events\\JwtCreatedSubscriber' => 'getJwtCreatedSubscriberService',
            'App\\Events\\PasswordEncoderSubscriber' => 'getPasswordEncoderSubscriberService',
            'App\\Repository\\CoachRepository' => 'getCoachRepositoryService',
            'App\\Repository\\CustomerRepository' => 'getCustomerRepositoryService',
            'App\\Repository\\ExercisesRepository' => 'getExercisesRepositoryService',
            'App\\Repository\\MemberRepository' => 'getMemberRepositoryService',
            'App\\Repository\\PartieCorpsRepository' => 'getPartieCorpsRepositoryService',
            'App\\Repository\\UserRepository' => 'getUserRepositoryService',
            'App\\Repository\\WorkoutExercisesRepository' => 'getWorkoutExercisesRepositoryService',
            'App\\Repository\\WorkoutRepository' => 'getWorkoutRepositoryService',
    ...
    protected function getDoctrine_Orm_DefaultEntityManagerService($lazyLoad = true)
    {
        ...
        $a->setRepositoryFactory(new \Doctrine\Bundle\DoctrineBundle\Repository\ContainerRepositoryFactory(new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'App\\Repository\\CoachRepository' => ['services', 'App\\Repository\\CoachRepository', 'getCoachRepositoryService', true],
            'App\\Repository\\CustomerRepository' => ['services', 'App\\Repository\\CustomerRepository', 'getCustomerRepositoryService', true],
            'App\\Repository\\ExercisesRepository' => ['services', 'App\\Repository\\ExercisesRepository', 'getExercisesRepositoryService', true],
            'App\\Repository\\MemberRepository' => ['services', 'App\\Repository\\MemberRepository', 'getMemberRepositoryService', true],
            'App\\Repository\\PartieCorpsRepository' => ['services', 'App\\Repository\\PartieCorpsRepository', 'getPartieCorpsRepositoryService', true],
            'App\\Repository\\UserRepository' => ['services', 'App\\Repository\\UserRepository', 'getUserRepositoryService', true],
            'App\\Repository\\WorkoutExercisesRepository' => ['services', 'App\\Repository\\WorkoutExercisesRepository', 'getWorkoutExercisesRepositoryService', true],
            'App\\Repository\\WorkoutRepository' => ['services', 'App\\Repository\\WorkoutRepository', 'getWorkoutRepositoryService', true],
        ], [
            'App\\Repository\\CoachRepository' => '?',
            'App\\Repository\\CustomerRepository' => '?',
            'App\\Repository\\ExercisesRepository' => '?',
            'App\\Repository\\MemberRepository' => '?',
            'App\\Repository\\PartieCorpsRepository' => '?',
            'App\\Repository\\UserRepository' => '?',
            'App\\Repository\\WorkoutExercisesRepository' => '?',
            'App\\Repository\\WorkoutRepository' => '?',
        ])));
    ...
    protected function getEventDispatcherService()
    {
        ...
        $instance->addListener('lexik_jwt_authentication.on_jwt_created', [0 => function () {
            return ($this->services['App\\Events\\JwtCreatedSubscriber'] ?? ($this->services['App\\Events\\JwtCreatedSubscriber'] = new \App\Events\JwtCreatedSubscriber()));
        }, 1 => 'updateJwtData'], 0);
        ...
        $instance->addListener('kernel.view', [0 => function () {
            return ($this->services['App\\Events\\PasswordEncoderSubscriber'] ?? $this->load('getPasswordEncoderSubscriberService'));
        }, 1 => 'encodePassword'], 33);
        $instance->addListener('kernel.response', [0 => function () {
    ...
    /**
     * Gets the private '.service_locator.jXJDvZn' shared service.
     *
     * @return \Symfony\Component\DependencyInjection\ServiceLocator
     */
    protected function get_ServiceLocator_JXJDvZnService()
    {
        return $this->privates['.service_locator.jXJDvZn'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
    ...
    {
        return $this->privates['api_platform.cache.identifiers_extractor'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('FUJP7hCwXZ', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('C9QUa6u5yp', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.property.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('yr-+a6oWP9', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('15HLNgE9rd', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource.legacy'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('f6RAf8fEra', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    {
        return $this->privates['api_platform.cache.metadata.resource_collection'] = new \Symfony\Component\Cache\Adapter\TraceableAdapter(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('vzL2+p6wv5', 0, $this->getParameter('container.build_id'), ($this->targetDir.''.'/pools/system'), ($this->privates['monolog.logger.cache'] ?? $this->getMonolog_Logger_CacheService())));
    }
    ...
    protected function getApiPlatform_FilterLocatorService()
    {
        return $this->privates['api_platform.filter_locator'] = new \Symfony\Component\DependencyInjection\Argument\ServiceLocator($this->getService, [
            'annotated_app_entity_exercises_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_exercises_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityExercisesApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
            'annotated_app_entity_partie_corps_api_platform_core_bridge_doctrine_orm_filter_search_filter' => ['privates', 'annotated_app_entity_partie_corps_api_platform_core_bridge_doctrine_orm_filter_search_filter', 'getAnnotatedAppEntityPartieCorpsApiPlatformCoreBridgeDoctrineOrmFilterSearchFilterService', true],
        ], [
            'annotated_app_entity_exercises_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
            'annotated_app_entity_partie_corps_api_platform_core_bridge_doctrine_orm_filter_search_filter' => '?',
        ]);
    }
    ...
    protected function getApiPlatform_Hydra_JsonSchema_SchemaFactoryService()
    {
        ...
        return $this->privates['api_platform.hydra.json_schema.schema_factory'] = new \ApiPlatform\Hydra\JsonSchema\SchemaFactory(new \ApiPlatform\JsonSchema\SchemaFactory($a, $b, $c, ($this->privates['api_platform.metadata.property.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_CachedService()), ($this->privates['serializer.name_converter.metadata_aware'] ?? $this->getSerializer_NameConverter_MetadataAwareService()), ($this->privates['api_platform.resource_class_resolver'] ?? $this->getApiPlatform_ResourceClassResolverService())));
    }
    ...
    protected function getApiPlatform_IriConverterService()
    {
        ...
        return $this->privates['api_platform.iri_converter'] = new \ApiPlatform\Core\Api\LegacyIriConverter(new \ApiPlatform\Core\Bridge\Symfony\Routing\IriConverter($a, ($this->privates['api_platform.metadata.property.metadata_factory.cached.legacy'] ?? $this->getApiPlatform_Metadata_Property_MetadataFactory_Cached_LegacyService()), $b, new \ApiPlatform\Core\Bridge\Symfony\Routing\CachedRouteNameResolver(($this->privates['api_platform.cache.route_name_resolver'] ?? $this->getApiPlatform_Cache_RouteNameResolverService()), new \ApiPlatform\Core\Bridge\Symfony\Routing\RouteNameResolver($c)), $c, ($this->privates['property_accessor'] ?? $this->getPropertyAccessorService()), ($this->privates['api_platform.identifiers_extractor.cached'] ?? $this->getApiPlatform_IdentifiersExtractor_CachedService()), $d, ($this->privates['api_platform.identifier.converter'] ?? $this->getApiPlatform_Identifier_ConverterService()), ($this->privates['api_platform.resource_class_resolver'] ?? $this->getApiPlatform_ResourceClassResolverService()), ($this->privates['api_platform.metadata.resource.metadata_factory.cached'] ?? $this->getApiPlatform_Metadata_Resource_MetadataFactory_CachedService())), $e);
    }
    ...
    protected function getApiPlatform_Listener_View_ValidateQueryParametersService()
    {
        ...
        return $this->privates['api_platform.listener.view.validate_query_parameters'] = new \ApiPlatform\Symfony\EventListener\QueryParameterValidateListener($a, new \ApiPlatform\Api\QueryParameterValidator\QueryParameterValidator(($this->privates['api_platform.filter_locator'] ?? $this->getApiPlatform_FilterLocatorService())), true);
    }
    ...
    {
        $a = ($this->privates['.service_locator.jXJDvZn'] ?? $this->get_ServiceLocator_JXJDvZnService());
    ...
    protected function getSerializerService()
    {
        ...
        $i = new \ApiPlatform\OpenApi\Serializer\ApiGatewayNormalizer(new \ApiPlatform\OpenApi\Serializer\OpenApiNormalizer(new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer(NULL, NULL, $g, $a)], [0 => $h])));
        ...
        $t = new \Symfony\Component\Serializer\Normalizer\ObjectNormalizer($r, $n, $g, $a, $s, NULL);

        return $this->privates['serializer'] = new \Symfony\Component\Serializer\Serializer([0 => new \Symfony\Component\Serializer\Normalizer\UnwrappingDenormalizer($g), 1 => $i, 2 => $m, 3 => new \ApiPlatform\Hydra\Serializer\ConstraintViolationListNormalizer($j, [], $n), 4 => new \ApiPlatform\Problem\Serializer\ConstraintViolationListNormalizer([], $n), 5 => $m, 6 => $i, 7 => new \ApiPlatform\Hydra\Serializer\DocumentationNormalizer($b, $c, $o, $p, NULL, $j, NULL, $n), 8 => new \ApiPlatform\Hydra\Serializer\EntrypointNormalizer($b, $q, $j), 9 => new \ApiPlatform\Hydra\Serializer\ErrorNormalizer($j, true), 10 => new \ApiPlatform\Problem\Serializer\ErrorNormalizer(true), 11 => new \Symfony\Component\Messenger\Transport\Serialization\Normalizer\FlattenExceptionNormalizer(), 12 => new \Symfony\Component\Serializer\Normalizer\ProblemNormalizer(true), 13 => new \Symfony\Component\Serializer\Normalizer\UidNormalizer(), 14 => new \ApiPlatform\JsonLd\Serializer\ItemNormalizer($b, $c, $o, $q, $p, $e, $g, $n, $r, [], new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $f), 15 => new \ApiPlatform\Serializer\ItemNormalizer($c, $o, $q, $p, $g, $n, $r, ($this->privates['api_platform.item_data_provider'] ?? $this->getApiPlatform_ItemDataProviderService()), false, NULL, new RewindableGenerator(function () {
            yield 0 => ($this->privates['api_platform.messenger.data_transformer'] ?? $this->load('getApiPlatform_Messenger_DataTransformerService'));
        }, 1), $b, $f), 16 => new \Symfony\Component\Serializer\Normalizer\DateTimeNormalizer(), 17 => new \Symfony\Component\Serializer\Normalizer\ConstraintViolationListNormalizer([], $n), 18 => new \Symfony\Component\Serializer\Normalizer\MimeMessageNormalizer(new \Symfony\Component\Serializer\Normalizer\PropertyNormalizer($r, $n, $a, $s, NULL)), 19 => new \Symfony\Component\Serializer\Normalizer\DateTimeZoneNormalizer(), 20 => new \Symfony\Component\Serializer\Normalizer\DateIntervalNormalizer(), 21 => new \Symfony\Component\Serializer\Normalizer\FormErrorNormalizer(), 22 => new \Symfony\Component\Serializer\Normalizer\BackedEnumNormalizer(), 23 => new \Symfony\Component\Serializer\Normalizer\DataUriNormalizer(($this->privates['mime_types'] ?? $this->getMimeTypesService())), 24 => new \Symfony\Component\Serializer\Normalizer\JsonSerializableNormalizer(NULL, NULL), 25 => new \ApiPlatform\Hydra\Serializer\CollectionFiltersNormalizer(new \ApiPlatform\Hydra\Serializer\PartialCollectionViewNormalizer(new \ApiPlatform\Hydra\Serializer\CollectionNormalizer($e, $p, $q, $b), 'page', 'pagination', $b, $g), $b, $p, $l), 26 => new \Symfony\Component\Serializer\Normalizer\ArrayDenormalizer(), 27 => new \ApiPlatform\JsonLd\Serializer\ObjectNormalizer($t, $q, $e), 28 => $t], [0 => new \Symfony\Component\Serializer\Encoder\XmlEncoder(), 1 => $h, 2 => new \Symfony\Component\Serializer\Encoder\YamlEncoder(NULL, NULL), 3 => new \Symfony\Component\Serializer\Encoder\CsvEncoder(), 4 => new \ApiPlatform\Serializer\JsonEncoder('jsonld'), 5 => new \ApiPlatform\Serializer\JsonEncoder('jsonproblem')]);
    }
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'lexik_jwt_authentication.token_ttl' => 300,
